...
export const Home: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Sheshan Edward — UI/UX Design & Full-Stack Development</title>
        <meta name="description" content="Portfolio of Sheshan Edward — UI/UX Designer and Full-Stack Developer at University of Staffordshire. Specialising in user research, Figma prototyping, and engineering-grounded design." />
        <link rel="canonical" href={`${BASE_URL}/`} />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`${BASE_URL}/`} />
        <meta property="og:title" content="Sheshan Edward — UI/UX Design & Full-Stack Development" />
        <meta property="og:description" content="Portfolio of Sheshan Edward — UI/UX Designer and Full-Stack Developer at University of Staffordshire. Specialising in user research, Figma prototyping, and engineering-grounded design." />
        <meta property="og:image" content={`${BASE_URL}/assets/images/Home.png`} />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Sheshan Edward — UI/UX Design & Full-Stack Development" />
        <meta name="twitter:description" content="Portfolio of Sheshan Edward — UI/UX Designer and Full-Stack Developer at University of Staffordshire. Specialising in user research, Figma prototyping, and engineering-grounded design." />
      ...
      <div className="space-y-16 sm:space-y-24 py-8 sm:py-12">
        ...
        <section className="max-w-4xl mx-auto text-center sm:text-left">
          ...
          <p className="mt-4 text-base sm:text-lg text-neutral-600 dark:text-neutral-400 leading-relaxed max-w-2xl">
            Year 2 Computer Science undergraduate at University of Staffordshire, targeting UI/UX design internship opportunities. I combine user research and structured design thinking with full-stack engineering experience — so the interfaces I design are grounded in what's actually feasible to build.
          </p>
